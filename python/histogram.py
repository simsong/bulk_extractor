class histogram(dict):
    ...
    def average(self):
        ...
        return sum(self.values()) / len(self.items())
    ...
    def print_topn(self,topn=1000000,func=False,title=""):
        print(title)
        print("  Rank     Count     Value(s):")
        print("  ============================")
        rank = 1
        total_count = 0
        print(self.topn(topn))
        for (count,vals) in self.topn(topn):
            for val in vals:
                fout = ""
