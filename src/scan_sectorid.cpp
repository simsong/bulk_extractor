        ...
        case scanner_params::PHASE_INIT: {
            ...
            switch(lookup_type) {
                ...
                default:
                    ...
                    std::cout << "Note: the sectorid scanner is enabled but no lookup type was selected.\n";
                    std::cout << "No output will be generated by the sectorid scanner.\n";
            }
            return;
        }
