...
public:
	...
	ip_recorder.write(sb2.pos0, ip2string(h.src, h.family), "struct " + name + src + " (src) " + chksum_status);
	ip_recorder.write(sb2.pos0, ip2string(h.dst, h.family), "struct " + name + dst + " (dst) " + chksum_status);
