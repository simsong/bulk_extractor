...
static __thread int (*uniUconvFromUcs) (
	  UconvObject,   /* I  - Uconv object handle         */
...
static __thread int uni_ready = 0;
static __thread HMODULE uni_UCONV;
static __thread UconvObject uni_obj;
