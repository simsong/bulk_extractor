...
|---|---|---|
| `README.md` | Previously called this the 2.1 development branch although `configure.ac` was 2.1.1; tested platforms stopped in 2023; names used by debug documentation differed from the code; scanner-ignore behavior and Windows validation were unclear. The current version and primary inconsistencies are corrected, but the page remains manually synchronized. | Make it the concise canonical build/use/status page generated or checked against current help and CI. |
...
- `make distcheck` passes the clean archive configure/build/test,
  ...
  `bulk_extractor-2.2.0.tar.gz`, including the vendored sources, licenses,
...
| Documentation and repository scope | [#476](https://github.com/simsong/bulk_extractor/issues/476), [#264](https://github.com/simsong/bulk_extractor/issues/264), [#139](https://github.com/simsong/bulk_extractor/issues/139) |
...
- [x] Update `README.md` from “2.1 development” to the current 2.2.0 version/status.
